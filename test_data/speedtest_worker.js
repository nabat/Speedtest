...
var settings = {
  ...
  url_dl: 'garbage.pl', // path to a large file or garbage.php, used for download test. must be relative to this js file
  url_ul: 'empty.pl', // path to an empty file, used for upload test. must be relative to this js file
  url_ping: 'empty.pl', // path to an empty file, used for ping test. must be relative to this js file
  url_getIp: 'getIP.pl', // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
